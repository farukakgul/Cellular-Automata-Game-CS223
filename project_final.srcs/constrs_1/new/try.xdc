...
##Buttons
set_property PACKAGE_PIN U18 [get_ports bttnRst]						
	set_property IOSTANDARD LVCMOS33 [get_ports bttnRst]
set_property PACKAGE_PIN T18 [get_ports bttn2]						
	set_property IOSTANDARD LVCMOS33 [get_ports bttn2]
set_property PACKAGE_PIN W19 [get_ports bttn1]						
	set_property IOSTANDARD LVCMOS33 [get_ports bttn1]
set_property PACKAGE_PIN T17 [get_ports bttn3]						
	set_property IOSTANDARD LVCMOS33 [get_ports bttn3]
set_property PACKAGE_PIN U17 [get_ports bttn4]						
	set_property IOSTANDARD LVCMOS33 [get_ports bttn4]
